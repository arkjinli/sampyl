...
from .hamiltonian_metric import energy, leapfrog, initial_momentum
import scipy.linalg as la


class EuclideanMetricNUTS(Sampler):
    ...
    def __init__(self, logp, mass, start,
                 step_size=0.25,
                 adapt_steps=100,
                 Emax=1000.,
                 target_accept=0.65,
        ...
        super(EuclideanMetricNUTS, self).__init__(logp, start, **kwargs)
